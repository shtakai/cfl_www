...
<cfquery name="myResume" datasource="learncfinaweek">
  select title, startDate, endDate, details, type from resume order by type desc, endDate, startDate
 </cfquery>
		...
		<div id="content">
			...
			<!-- resume -->
                ...
                <cfoutput query="myResume" group="type">
                  ...
                  <cfoutput>
                    <h5>#myResume.title#<span>#dateFormat(myResume.startDate,"mm/dd/yyyy")#
to <cfif len(myResume.endDate)>#dateFormat(myResume.endDate,"mm/dd/yyyy")#<cfelse>present</cfif></span> </h5>
